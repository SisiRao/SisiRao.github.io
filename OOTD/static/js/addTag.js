...
function updateInitPK(posts){
    if($(posts).length) {
        ...
        $("#new-msg-container").empty().append(
			"<a id=\"new-msg-banner\" style=\"display:block;\" class=\"bounceIn animated\"> Loaded "+pk_len+" outfits</a>");
...
function updateOutfit(posts){
	if($(posts).length) {
		$("#new-msg-container").empty().css("display","block").append(
			"<a id=\"new-msg-banner\" style=\"display:block;\" class=\"bounceIn animated\" href=\"/OOTD\"><span> New Outfit. Refresh to see </span></a>");
	}
